...
public class MainMenuShader
{
    ...
    public MainMenuShader(final String fragmentShaderLocation) throws IOException {
    ...
    public int createShader(final InputStream inputStream, final int shaderType) throws IOException {
